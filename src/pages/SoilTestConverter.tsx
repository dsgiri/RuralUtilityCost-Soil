    ...
    <div className="mx-auto max-w-3xl space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-slate-200 pb-6 gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-500">Convert lab report parts per million (ppm) to pounds per acre.</p>
        </div>
        <div className="flex shrink-0 border border-slate-200 bg-white shadow-sm ring-1 ring-slate-900/5 items-center">
           <div className="bg-slate-100 px-3 py-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest border-r border-slate-200 h-full flex flex-col justify-center">
             Verification
           </div>
           <button 
             onClick={() => setStatus(s => s === "Pending Human Verification" ? "Filing Complete" : "Pending Human Verification")}
             className={`px-3 py-2 text-[10px] font-bold uppercase tracking-widest transition-colors h-full ${
      ...
      <div className="bg-white border border-slate-200 shadow-sm ring-1 ring-slate-900/5">
        ...
        <div className="bg-slate-50 border-t border-slate-200 p-6 border-b-4 border-[#4C7C44]">
          ...
          <p className="mt-4 text-[10px] text-slate-500 leading-relaxed border-t border-slate-200 pt-4">
            Standard 6-inch furrow slice assumes ~2 million lbs of soil mass per acre. Conversion utilized for regulatory compliance and nutrient tracking.
          </p>
        </div>
      </div>
    </div>
